...
let questions = [
   ...
   },
   {
    ...
    {
	"question": "10. What year did Islam start to appear from the Prophet Muhammad?",
	"a": "650",
	"b": "620",
	"c": "610",
	"d": "600",
...
let getHintF = function() {
 ...
 function loadQuestion() {
  ...
  let downloadTimer = setInterval(function(){
      ...
      // update display
      document.getElementById("countdown").innerHTML = timeleft + " seconds remaining, finish Quiz QUICKLY!";
  ...
  if (timeleft <= 20) {
	  document.getElementById("countdown").innerHTML = timeleft + " seconds remaining, FINISH BEFORE YOU LOSE!";
  }
}, 1000);
